...
//         sc.selectByIndex(1);
          driver.findElement(By.xpath("//input[@id='name']")).sendKeys("CephSnapshot432");
 ...
 driver.findElement(By.xpath("//a[contains(text(),'Host')]")).click();
        ...
        Thread.sleep(3000);
  driver.findElement(By.xpath("//input[@name='hostFormName']")).sendKeys("Ceph-host1125");
 ...
 WebElement initiator =driver.findElement(By.xpath("//select[@id='hostPortSelect']"));
  ...
  public  void appdeployment() throws InterruptedException
    ...
    driver.findElement(By.xpath("//textarea[@name='clusterFileTab1']")).sendKeys("apiVersion: v1\n" + 
    		...
    		"");
    Thread.sleep(2000);
      driver.findElement(By.xpath("//ng-form[@name='passclu1']//div//button")).click();
      
      Thread.sleep(3000);
      driver.findElement(By.xpath("//body/div[@id='center_div']/div/div/div/div[@id='main-content']/div/div/div/div/div/div/div/div/div[@id='s4']/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/a[1]")).click();
      Thread.sleep(3000);
      
      driver.findElement(By.xpath("//body//div[@id='s4']//div//div//div//div//div//div[1]//div[1]//div[1]//div[1]//ul[1]//li[1]//a[1]")).click();
      driver.findElement(By.xpath("//body/div[@id='center_div']/div/div/div/div[@id='main-content']/div/div/div/div/div/div/div/div/div[@id='s4']/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/a[1]")).click();
      Thread.sleep(3000);
      
      driver.findElement(By.xpath("//body//div[@id='s4']//div//div//div//div//div//div[1]//div[1]//div[1]//div[1]//ul[1]//li[1]//a[2]")).click();
      Thread.sleep(3000);
      driver.findElement(By.xpath("//div[@id='deploy_tab1']//div//div//div//textarea[@id='deployFileContentID']")).sendKeys("# This YAML file contains nginx & csi opensds driver objects,\n" + 
      		...
      		"parameters:\n" + 
      		"  attachMode: rw\n" + 
      		"  profile: 7c37ab95-dc19-467b-a468-d2b28c4b9132\n" + 
      		"allowedTopologies:\n" + 
      		...
      		"      readOnly: false");
      driver.findElement(By.xpath("//div[@id='deploy_tab1']//div//button")).click();
      
      Thread.sleep(2000);
      driver.findElement(By.xpath("//body//div[@id='s4']//div//div//div//div//div//div[1]//div[1]//div[1]//div[1]//ul[1]//li[1]//a[1]")).click();
  WebElement status =  driver.findElement(By.xpath("//body//div[@id='s4']//div//div//div//div//div//div[1]//div[1]//div[1]//div[1]//ul[1]//li[1]//a[3]"));
